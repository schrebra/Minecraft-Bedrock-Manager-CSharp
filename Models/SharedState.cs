...
public sealed class SharedState
{
    ...
    // Local Backup Properties
    public bool   LocalBackupEnabled    { get; set; } = true;
    public string LocalBackupPath       { get; set; } = "";
    public string LocalBackupTime       { get; set; } = "01:00";
    public DateTime? NextLocalBackupDate { get; set; }

    // Offsite Backup Properties
    public bool   OffsiteBackupEnabled    { get; set; } = false;
    public string OffsiteBackupPath       { get; set; } = "";
    public string OffsiteBackupTime       { get; set; } = "02:00";
    public DateTime? NextOffsiteBackupDate { get; set; }

    // Admin Warning Properties
    public bool   DontShowAdminWarning   { get; set; } = false;
    public int    AdminWarningShownCount { get; set; } = 0;

    // Hung Process Detection Properties
    public bool   ServerStopRequested  { get; set; }
    public DateTime? ServerStopRequestedTime { get; set; }
